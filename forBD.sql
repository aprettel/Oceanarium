...
INSERT INTO Residents (ResidentID, ImageURL, Name, Species, Age, Description) VALUES
(12, 'Penguin.jpg', 'Пингвин', 'Spheniscidae', 9, 'Птица, обитающая в холодных морях. Имеет черно-белое оперение и способна плавать и нырять в воде.
 Является символом Антарктиды и привлекает внимание своими необычными способами передвижения на суше и в воде.');